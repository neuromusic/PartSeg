...
<OME xmlns="http://www.openmicroscopy.org/Schemas/OME/2016-06"
  ...
  <StructuredAnnotations xmlns="{ns_sa_default}s"/>
    ...
    ns_ome_default=NS_DEFAULT.format(ns_key="ome"), ns_sa_default=NS_DEFAULT.format(ns_key="sa")
)
...
class OMEXML(object):
    ...
    def __init__(self, xml=None):  # noqa: F811
        if xml is None:
            xml = default_xml
    ...
    def __str__(self):
        ...
        result = StringIO()
        ElementTree.ElementTree(self.root_node).write(result, encoding=uenc, method="xml")
    ...
    def set_image_count(self, value):
        ...
        while self.image_count < value:
            ...
            new_pixels = self.Pixels(ElementTree.SubElement(new_image.node, qn(self.ns["ome"], "Pixels")))
            ...
            new_pixels.SizeZ = 1
            new_channel = self.Channel(ElementTree.SubElement(new_pixels.node, qn(self.ns["ome"], "Channel")))
    ...
    def structured_annotations(self):
        ...
        if node is None:
            node = ElementTree.SubElement(self.root_node, qn(self.ns["sa"], "StructuredAnnotations"))
    ...
    class Image(object):
        ...
        def set_AcquisitionDate(self, date):
            acquired_date = self.node.find(qn(self.ns["ome"], "AcquisitionDate"))
            if acquired_date is None:
                acquired_date = ElementTree.SubElement(self.node, qn(self.ns["ome"], "AcquisitionDate"))
        ...
        def set_channel_count(self, value):
            ...
            if channel_count > value:
                ...
                for _ in range(channel_count, value):
                    new_channel = OMEXML.Channel(ElementTree.SubElement(self.node, qn(self.ns["ome"], "Channel")))
        ...
        def set_plane_count(self, value):
            ...
            if plane_count > value:
                ...
                for _ in range(plane_count, value):
                    new_plane = OMEXML.Plane(  # noqa: F841
    ...
    class StructuredAnnotations(dict):
        ...
        def keys(self):
            return filter(lambda x: x is not None, [child.get("ID") for child in self.node])
        ...
        def add_original_metadata(self, key, value):
            ...
            """
            xml_annotation = ElementTree.SubElement(self.node, qn(self.ns["sa"], "XMLAnnotation"))
            node_id = str(uuid.uuid4())
            xml_annotation.set("ID", node_id)
            xa_value = ElementTree.SubElement(xml_annotation, qn(self.ns["sa"], "Value"))
            ov = ElementTree.SubElement(xa_value, qn(NS_ORIGINAL_METADATA, "OriginalMetadata"))
        ...
        def has_original_metadata(self, key):
            ...
            return any([k == key for annotation_id, (k, v) in self.iter_original_metadata()])
    ...
    class OriginalMetadata(dict):
        ...
        def keys(self):
            return [key for annotation_id, (key, value) in self.sa.iter_original_metadata()]
    ...
    class PlatesDucktype(object):
        ...
        def newPlate(self, name, plate_id=str(uuid.uuid4())):
            new_plate_node = ElementTree.SubElement(self.root, qn(self.ns["spw"], "Plate"))
    ...
    class Plate(object):
        ...
        ColumnNamingConvention = property(get_ColumnNamingConvention, set_ColumnNamingConvention)
        ...
        def get_well_name(self, well):
            ...
            result = "".join(
                [
                    "%02d" % (i + 1) if convention == NC_NUMBER else "ABCDEFGHIJKLMNOP"[i]
                    for i, convention in (
    ...
    class WellsDucktype(dict):
        ...
        def new(self, row, column, well_id=str(uuid.uuid4())):
            ...
            """
            well_node = ElementTree.SubElement(self.plate_node, qn(self.ns["spw"], "Well"))
    ...
    class WellSampleDucktype(list):
        ...
        def new(self, wellsample_id=str(uuid.uuid4()), index=None):
            ...
            new_node = ElementTree.SubElement(self.well_node, qn(self.ns["spw"], "WellSample"))
